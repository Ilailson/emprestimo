    ...
    <div class="bg-slate-900 border border-slate-800 rounded-xl p-4 sm:p-6">
      <form @submit.prevent="salvar" class="space-y-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3 pt-2">
          <button type="submit" class="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-all font-medium shadow-lg shadow-blue-500/25 min-h-[48px]">
        ...
        <button v-if="!editando" type="button" @click="salvarComEmprestimo" class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg transition-all font-medium min-h-[48px]">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
